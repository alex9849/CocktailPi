  ...
  page: {
    ...
    pump_setup: {
      ...
      calibration: {
        ...
        power_consumption_desc: 'Wie viel Leistung benötigt diese Pumpe? CocktailPi lässt, nur so viele Pumpen gleichzeitig laufen, wie das Netzteil gleichzeitig versorgen kann.',
        motor_tester: {
