export default {
  ...
  page: {
    ...
    user_mgmt: {
      ...
      login_with_password_only_label: 'Login nur mit Passwort',
  ...
  component: {
    ...
    make_cocktail_dialog: {
      ...
      price_value: 'Herstellungspreis: {price}',
      price_unavailable: 'Herstellungspreis: nicht verfügbar'
    },
